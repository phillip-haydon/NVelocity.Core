...
namespace NVelocity.Test
{
    ...
    public class MacroTestCase
	{
		...
		[Fact(Skip = "Does not pass, but would be easier to rewrite NVelocity than fix it")]
		public void RecursiveMacroHaveArgsStacked()
		{
			...
			Assert.True(success, "Evaluation failed");
			Assert.Equal("12Done21", sw.GetStringBuilder().ToString());
		}
	}
}