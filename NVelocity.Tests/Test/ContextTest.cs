...
namespace NVelocity.Test
{
	...
	public class ContextTest
	{
		...
		public void ParamArraySupportAndForEach2()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal(" x,y x c,d,e", sw.ToString());
		}
		...
		public void ForEachSimpleCase()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal(" 16 17 18", sw.ToString());
		}
		...
		public void Hashtable1()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal("value1", sw.ToString());
		}
		...
		public void CaseInsensitive()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal("Hello Cort $lastName", sw.ToString());
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal("Hello Cort Schaefer", sw.ToString());
		...
		public void PropertiesAreAlsoCaseInsensitive()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal("Hello hammett", sw.ToString());
