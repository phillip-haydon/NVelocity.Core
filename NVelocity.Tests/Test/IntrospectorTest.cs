...
namespace NVelocity.Test
{
	...
	public class IntrospectorTest
	{
		...
		public void Test_Evaluate()
		{
			...
			Assert.NotNull(mi);
			Assert.True(mi.ToString().Equals("Void Test_Evaluate()"), "method not found");

			mi = i.GetMethod(typeof(ExtendedProperties), "GetString", new Object[] {"parm1", "parm2"});
			Assert.NotNull(mi);
			Assert.True(mi.ToString().Equals("System.String GetString(System.String, System.String)"), "method not found");
		}
	}
}