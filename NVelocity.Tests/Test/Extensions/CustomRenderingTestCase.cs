...
namespace NVelocity.Test.Extensions
{
	...
	public class CustomRenderingTestCase
	{
		...
		public void EscapeEscapableSimpleObject()
		{
			...
			Assert.Equal(@"&lt;escape me&gt; | normal>not<escapable", sw.ToString());
		}
		...
		public void EscapeEscapableComplexObject()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal(@"my&gt;name my&amp;value | normal>not<escapable", sw.ToString());
		}
		...
		public void EscapeEscapableComplexMixedObject()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal(@"escape&amp;me don't &escape> me | normal>not<escapable", sw.ToString());
		}
		...
		public void ReplaceSingleItem()
		{
			...
			Assert.True(ok, "Evaluation returned failure");
			Assert.Equal(@"New single item", sw.ToString());
		}
